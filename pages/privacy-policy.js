...
let Privacy = () => {
	return (
		<>
			<Head>
				<title>Weather Forecast App | Privacy Policy</title>
			</Head>
			<div className="p-4 space-y-6 max-w-4xl mx-auto">
				<PrivacyTermsItem title="Privacy Policy">
					<div className="space-y-2">
						<p>
							<span className="font-semibold">Effective date:</span> August 29,
							2021.
						</p>
						<p>
							We do not collect data, but we use some Third Party Services that
							my do. This app may contain false data and we do not knowingly
							serve it. It's just a personnal project specifically built to
							enrich portfolio and nothing more, if you want information about
							the weather please use other apps.
						</p>
					</div>
				</PrivacyTermsItem>
				<PrivacyTermsItem title="Analytics">
					<p>
						...
						use of our Service such as Google Analytics, which is a web
						...
						installing the Google Analytics opt-out browser add-on. For more
				...
				<PrivacyTermsItem title="Contact Us">
					<p>
						...
						us by email @ info.fouadhanani@gmail.com
					</p>
				</PrivacyTermsItem>
			</div>
		</>
